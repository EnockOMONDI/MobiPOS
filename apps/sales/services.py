...
from .models import ReturnStatus, SaleStatus
...
def complete_return(*, sale_return, actor):
    ...
    for line in sale_return.sale.lines.select_related("product", "stock_unit"):
        ...
        post_stock_movement(
            ...
            quantity=line.quantity - line.returned_quantity, movement_type=StockMovementType.CUSTOMER_RETURN,
        ...
        if line.stock_unit:
            line.stock_unit.status = SerialStatus.RETURNED
