...
NAVIGATION_GROUPS = (
    ...
    ("Inventory", "box", (
        ...
        item("Agent stock", "module-overview", "box", "inventory.view_stockunit", ("agent-stock",)),
    ...
    ("Reports", "chart", (
        ...
        item("Agent network report", "agent-network-report", "truck", owner_only=True, requestable=False),
        ...
        item("Activity report", "activity-report", "lock", "organizations.view_activity_report"),
    )),
    ("Administration", "cog", (
        item("Users and access", "membership-access-list", "cog", owner_only=True, requestable=False),
        item("Agent profiles", "module-overview", "truck", owner_only=True, args=("agents",), requestable=False),
